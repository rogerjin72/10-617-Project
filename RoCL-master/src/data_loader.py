...
def get_dataset(args):
    ...
    if args.dataset == 'cifar-10':
        ...
        train_dst   = CIFAR10(root='', train=True, download=True,
                                        transform=transform_train,contrastive_learning=learning_type)
        val_dst     = CIFAR10(root='', train=False, download=True,
        ...
        if learning_type=='contrastive':
            ...
            train_loader = torch.utils.data.DataLoader(train_dst,batch_size=args.batch_size,num_workers=0,
                    pin_memory=False,
                    shuffle=True,
                )
