...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, contrastive_learning=True):
    ...
    def forward(self, x, internal_outputs=False):
        out = x
        out_list = []
