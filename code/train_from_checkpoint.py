...
# load checkpoint
CHECKPOINT = 'checkpoint/ckpt.t7training_1contrastive_ResNet18_cifar-10_b256_l256_0'
...
scheduler_cosine = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, args.epoch - start_epoch)
...
optimier = optimizer.load_state_dict(optimizer)
...
def train(epoch):
    ...
    for batch_idx, (ori, inputs_1, inputs_2, label) in tqdm(enumerate(trainloader)):
        if args.use_cuda:
